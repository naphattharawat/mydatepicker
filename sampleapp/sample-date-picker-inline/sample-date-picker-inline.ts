...
import {IMyDpOptions, IMyDateModel, IMyCalendarViewChanged} from '../../projects/mydatepicker/src/lib/interfaces';

@Component({
    selector: 'sample-date-picker-inline',
    styleUrls: ['./sample-date-picker-inline.css'],
